 ...
 */
export const getUrlValue = (key, urlStr = location.href) => {
 ...
 * @param urlStr 链接地址，默认为当前浏览器的地址
 */
export const getUrlNumberValue = (key, urlStr = location.href) => {
 ...
 * @return 求和结果，默认为 0
 */
export const getSumValue = (values) => {
 ...
 * @return 格式化后的数量
 */
export const erpNumberFormatter = (num, digit) => {
  if (num === null) {
    return ''
  }
 ...
 * @return 格式化后的数量
 */
export const erpCountInputFormatter = (num) => {
 ...
 * @return 格式化后的数量
 */
export const erpCountTableColumnFormatter = (_, __, cellValue, ___) => {
 ...
 * @return 格式化后的数量
 */
export const erpPriceInputFormatter = (num) => {
 ...
 * @return 格式化后的数量
 */
export const erpPriceTableColumnFormatter = (_, __, cellValue, ___) => {
 ...
 */
export const erpPriceMultiply = (price, count) => {
